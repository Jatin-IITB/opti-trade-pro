...
from src.options_trading.models.auth import (
...
from src.options_trading.utils.exceptions import AuthError, TokenRefreshError
...
class TestAuthService:
    ...
    @pytest.mark.asyncio
    async def test_get_valid_access_token_cached(self, mock_settings, mock_secure_storage, sample_token_info):
    ...
    @pytest.mark.asyncio
    async def test_get_valid_access_token_refresh_needed(self, mock_settings, mock_secure_storage, expired_token_info):
    ...
    @pytest.mark.asyncio
    async def test_get_auth_status_authenticated(self, mock_settings, mock_secure_storage, sample_token_info):
    ...
    @pytest.mark.asyncio
    async def test_get_auth_status_expired(self, mock_settings, mock_secure_storage, expired_token_info):

...
from src.options_trading.config.settings import get_settings
from src.options_trading.models.auth import TokenInfo
from src.options_trading.services.auth_service import AuthService
...
def mock_settings(test_settings, monkeypatch):
    ...
    monkeypatch.setattr("src.options_trading.config.settings.get_settings", mock_get_settings)
    return settings_mock
...
def sample_option_contracts():
    ...
    return pd.DataFrame({
        'instrument_key': ['NSE_INDEX|99926000', 'NSE_INDEX|99926001', 'NSE_INDEX|99926002', 'NSE_INDEX|99926003'],
        'trading_symbol': ['NIFTY24JAN22000CE', 'NIFTY24JAN22000PE', 'NIFTY24JAN22100CE', 'NIFTY24JAN22100PE'],
...
def mock_upstox_api_responses():
    ...
    return {
        ...
        'expiries': {
            ...
            'json': {
                'status': 'success',
                'data': ['2024-01-25', '2024-02-29', '2024-03-28']
            }
        },
        'contracts': {
            'status_code': 200,
        ...
        'spot_candles': {
            ...
            'json': {
                ...
                'data': {
                    'candles': [
                        ['2024-01-15T09:15:00+05:30', 22000.0, 22050.0, 21950.0, 22025.0, 100000, 500000],
                        ['2024-01-15T09:18:00+05:30', 22025.0, 22075.0, 21975.0, 22050.0, 110000, 510000],
                    ]
                }
            }
        }

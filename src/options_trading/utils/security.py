...
class SecureStorage:
    ...
    async def store_token(self, token_info: TokenInfo) -> None:
        ...
        try:
            ...
            token_data = {
                ...
                "refresh_token": self._encrypt_data(token_info.refresh_token) if token_info.refresh_token else None,
    ...
    async def load_token(self, user_id: str) -> Optional[TokenInfo]:
    ...
    async def get_storage_info(self) -> Dict[str, any]:
        ...
        try:
            ...
            return {
                ...
                ).isoformat() if self.token_file.exists() else None
            }
        except Exception as e:

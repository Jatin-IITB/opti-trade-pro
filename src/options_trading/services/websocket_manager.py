...
class WebSocketManager:
    ...
    async def connect(self, websocket: WebSocket, client_id: str) -> None:
        ...
        try:
            ...
            logger.info(f"Client {client_id} connected. Active connections: {self._stats['active_connections']}")
        ...
        try:
            async with self._lock:
                if client_id in self.connections:
                    ...
                    logger.info(f"Client {client_id} disconnected. Active connections: {self._stats['active_connections']}")
        ...
        return {
            **self._stats,
            ...
            "avg_subscriptions_per_client": (
                active_subscriptions / len(self.connections) 
